...
namespace Wiedza.Api.Migrations
{
    ...
    [Migration("20240724130210_ComplaintSeperation")]
    partial class ComplaintSeperation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wiedza.Core.Models.Data.Base.Complaint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("AdministratorId")
                        .HasDatabaseName("ix_complaints_administrator_id");

                    b.HasIndex("AttachmentFileId")
                        .HasDatabaseName("ix_complaints_attachment_file_id");

                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_complaints_author_id");
            ...
            modelBuilder.Entity("Wiedza.Core.Models.Data.PersonComplaint", b =>
                {
                    b.HasBaseType("Wiedza.Core.Models.Data.Base.Complaint");
            ...
            modelBuilder.Entity("Wiedza.Core.Models.Data.Base.Complaint", b =>
                {
                    b.HasOne("Wiedza.Core.Models.Data.Administrator", "Administrator")
                        ...
                        .HasConstraintName("fk_complaints_admins_administrator_id");
                    ...
                    b.HasOne("Wiedza.Core.Models.Data.AttachmentFile", "AttachmentFile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_complaints_files_attachment_file_id");
                    ...
                    b.HasOne("Wiedza.Core.Models.Data.Person", "Author")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_complaints_persons_author_id");
            ...
            modelBuilder.Entity("Wiedza.Core.Models.Data.PersonComplaint", b =>
                {
                    b.HasOne("Wiedza.Core.Models.Data.Base.Complaint", null)
                        .WithOne()
                        .HasForeignKey("Wiedza.Core.Models.Data.PersonComplaint", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_person_complaints_complaints_id");
            ...
            modelBuilder.Entity("Wiedza.Core.Models.Data.PublicationComplaint", b =>
                {
                    b.HasOne("Wiedza.Core.Models.Data.Base.Complaint", null)
                        .WithOne()
                        .HasForeignKey("Wiedza.Core.Models.Data.PublicationComplaint", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_publication_complaints_complaints_id");
