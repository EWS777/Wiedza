        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    publication_type = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_withdraws_administrators_administrator_id",
                        column: x => x.administrator_id,
                        principalTable: "admins",
                        principalColumn: "id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_withdraws_administrator_id",
                table: "withdraws",
                column: "administrator_id");
