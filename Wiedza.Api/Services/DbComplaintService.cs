    ...
    ) : IComplaintService
{
    ...
    public async Task<Result<PersonComplaint>> AddPersonComplaintAsync(string username, Guid authorId, AddComplaintRequest request)
    {
    ...
    public async Task<Result<PublicationComplaint>> AddPublicationComplaintAsync(ulong publicationId, Guid authorId, AddComplaintRequest request)
    {
